...
public class Map {
    ...
    public static final char borderSide = '|';
    public static final char borderTop = '—';
    public static final char corner = '+';
    public static final char emptySpace = 'X';
    public static final char gobChar = 'G';
    public static final char humChar = 'H';
